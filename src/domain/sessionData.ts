...
export const myInfoSections: MyInfoSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        label: "Employment",
        value: "Self-employed designer",
        source: "Declared",
      },
      {
        label: "Income pattern",
        value: "Variable freelance income",
        source: "Declared",
      },
    ],
  },
  {
    ...
    fields: [
      {
        label: "Housing",
        value: "Rents with family support",
        source: "Declared",
      },
      {
        label: "Education",
        value: "Diploma / design training",
        source: "MyInfo",
      },
      {
        label: "CPF signal",
        value: "Irregular self-employed contributions",
        source: "CPF",
      },
    ],
  },
...
export const coverageItems: CoverageItem[] = [
  ...
  },
  {
    ...
    source: "Client profile + session notes",
    tone: "red",
  },
  {
    id: "critical-illness",
  ...
  },
  {
    ...
    source: "Client profile + affordability discussion",
    tone: "green",
  },
];
...
export const decisionOptions: DecisionOption[] = [
  {
    ...
    linkedNeeds: [
      ...
      "MediShield Life/private shield clarity",
    ],
  ...
  },
  {
    ...
    linkedNeeds: [
      ...
      "Bills during recovery or no-work periods",
    ],
    effects: ["Separates income risk", "Frames neutral questions"],
    limitations: [
      "No product recommendation",
      "Suitability stays with advisor",
    ],
    clientSummary:
  ...
  },
  {
    ...
    linkedNeeds: [
      ...
      "Need for cash support beyond hospital bills",
    ],
  ...
  },
  {
    ...
    linkedNeeds: [
      "Therapy or counselling questions",
      "Standalone outpatient support",
    ],
    effects: ["Plain-language boundary", "Clear close-out point"],
    limitations: [
      "Standalone outpatient not included here",
      "Alternatives require advisor",
    ],
    clientSummary:
